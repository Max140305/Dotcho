...
const T = {
  id: {
    ...
    // Order page options
    'opt.sugargrp': 'Kadar Gula', 'opt.foamgrp': 'Extra Foam', 'opt.takeawaygrp': 'Dine-in / Takeaway',
    'opt.notelbl': 'Catatan', 'opt.optional': '(opsional)', 'opt.required': 'Wajib',
    'opt.no-sugar': 'Tanpa Gula', 'opt.normal': 'Normal', 'opt.sweet': 'Manis',
    'opt.no-foam': 'Tidak', 'opt.extra-foam': 'Iya, minta', 'opt.dine-in': 'Di sini',
    'opt.takeaway': 'Bawa pulang (+Rp500)',
    'btn.addcart': 'Tambah ke Keranjang', 'btn.ordernow': 'Pesan Sekarang',
    'ord.backmenu': '← Kembali ke Menu', 'ord.whatcust': 'Kata Pelanggan',
    'ord.revfor': 'Ulasan untuk', 'ord.norev': 'Belum ada ulasan untuk menu ini.',
    // Reviews page
    'rev.eye': 'Suara Pelanggan',
    'rev.h1': 'Kata <em>jujur,</em><br>dari lidah yang <em>jujur.</em>',
    'rev.desc': 'Setiap ulasan terverifikasi — dari seseorang yang benar-benar memesan. Kami tidak menyaring, tidak menyensor.',
    'rev.stat.rating': 'Rating Rata-rata', 'rev.stat.total': 'Total Ulasan',
    'rev.stat.five': 'Ulasan Bintang 5', 'rev.stat.reorder': 'Akan Pesan Lagi',
    // Admin
    'adm.dashboard': 'Dasbor', 'adm.orders': 'Pesanan', 'adm.inventory': 'Inventori & Stok',
    'adm.menu': 'Manajemen Menu', 'adm.reviews': 'Ulasan & Pelanggan',
    'adm.members': 'Member & Loyalitas', 'adm.analytics': 'Analitik & Laporan',
    'adm.signout': 'Keluar', 'adm.viewall': 'Lihat semua →', 'adm.manage': 'Kelola →',
    'adm.opensite': '↗ Buka situs pelanggan',
    'adm.recent_orders': 'Pesanan Terbaru', 'adm.stock_alerts': 'Peringatan Stok',
    'adm.all': 'Semua', 'adm.new': 'Baru', 'adm.progress': 'Diproses', 'adm.done': 'Selesai',
    'adm.mark_paid': 'Tandai lunas', 'adm.start_prep': 'Mulai prep', 'adm.complete': 'Selesai',
    'adm.paid_pill': 'LUNAS', 'adm.unpaid_pill': 'BELUM LUNAS',
    'adm.status.new': 'Baru', 'adm.status.progress': 'Diproses',
    'adm.status.done': 'Selesai', 'adm.status.cancelled': 'Dibatalkan',
    'adm.ingredients': 'Semua Bahan', 'adm.ingredients_sub': 'Hijau OK · Kuning Perhatian · Merah Kritis',
    'adm.avail_sub': 'Ubah ketersediaan — langsung tampil di situs pelanggan',
    'adm.allrev': 'Semua Ulasan', 'adm.verifiedchron': 'Terverifikasi · kronologis',
    'adm.ratingdist': 'Distribusi Rating', 'adm.custseg': 'Segmentasi Pelanggan',
    'adm.members_sub': 'Earn 1 poin / Rp1.000 · 100 poin = Rp1.000 · tier otomatis',
    'adm.allmbr': 'Semua Member', 'adm.mbr_sub': 'Urut berdasar saldo poin · identitas = nomor WhatsApp',
    'adm.analytics_sub': 'Business intelligence langsung — dari data pesanan nyata',
    'adm.rev7d': 'Pendapatan — 7 Hari Terakhir', 'adm.rev7d_sub': 'Pesanan berbayar saja',
    'adm.topseller': 'Penjual Terbaik', 'adm.topseller_sub': 'Berdasarkan jumlah cup',
    'adm.orderstatus': 'Status Pesanan', 'adm.paymethod': 'Metode Pembayaran',
    'adm.export_members': '⬇ Export Member CSV', 'adm.export_sales': '⬇ Laporan Penjualan',
    'adm.export_orders': '⬇ CSV Pesanan',
    ...
    'rev.eye': 'Suara Pelanggan',
    'rev.h1': 'Kata <em>jujur,</em><br>dari lidah yang <em>jujur.</em>',
    'rev.desc': 'Setiap ulasan terverifikasi — dari seseorang yang benar-benar memesan. Kami tidak menyaring.',
    'rev.stat.rating': 'Rating Rata-rata', 'rev.stat.total': 'Total Ulasan',
    'rev.stat.five': 'Ulasan Bintang 5', 'rev.stat.reorder': 'Akan Pesan Lagi',
    // Admin
    'adm.dashboard': 'Dasbor', 'adm.orders': 'Pesanan', 'adm.inventory': 'Inventori & Stok',
    ...
    'adm.status.new': 'Baru', 'adm.status.progress': 'Diproses',
    'adm.status.done': 'Selesai', 'adm.status.cancelled': 'Dibatalkan',
    'adm.ingredients': 'Semua Bahan', 'adm.allrev': 'Semua Ulasan',
    'adm.ratingdist': 'Distribusi Rating', 'adm.custseg': 'Segmentasi Pelanggan',
    'adm.allmbr': 'Semua Member', 'adm.rev7d': 'Pendapatan 7 Hari',
    'adm.topseller': 'Penjual Terbaik', 'adm.orderstatus': 'Status Pesanan',
    'adm.paymethod': 'Metode Pembayaran',
    // Track
  ...
  en: {
    ...
    // Order page options
    'opt.sugargrp': 'Sugar Level', 'opt.foamgrp': 'Extra Foam', 'opt.takeawaygrp': 'Dine-in / Takeaway',
    'opt.notelbl': 'Add a note', 'opt.optional': '(optional)', 'opt.required': 'Required',
    'opt.no-sugar': 'No Sugar', 'opt.normal': 'Normal', 'opt.sweet': 'Sweet',
    'opt.no-foam': 'No Extra', 'opt.extra-foam': 'Yes, please', 'opt.dine-in': 'Dine in',
    'opt.takeaway': 'Takeaway (+Rp500)',
    'btn.addcart': 'Add to Cart', 'btn.ordernow': 'Order Now',
    'ord.backmenu': '← Back to Menu', 'ord.whatcust': 'What customers say',
    'ord.revfor': 'Reviews for', 'ord.norev': 'No reviews yet for this item.',
    // Reviews page
    'rev.eye': 'Customer Voices',
    'rev.h1': 'Honest <em>words,</em><br>from honest <em>tongues.</em>',
    'rev.desc': "Every review is verified — left by someone who actually ordered. We don't filter, we don't censor.",
    'rev.stat.rating': 'Average Rating', 'rev.stat.total': 'Total Reviews',
    'rev.stat.five': '5-Star Reviews', 'rev.stat.reorder': 'Would Reorder',
    // Admin
    'adm.dashboard': 'Dashboard', 'adm.orders': 'Orders', 'adm.inventory': 'Inventory & Alerts',
    'adm.menu': 'Menu Management', 'adm.reviews': 'Reviews & Customers',
    'adm.members': 'Members & Loyalty', 'adm.analytics': 'Analytics & Reports',
    'adm.signout': 'Sign out', 'adm.viewall': 'View all →', 'adm.manage': 'Manage →',
    'adm.opensite': '↗ Open customer site',
    'adm.recent_orders': 'Recent Orders', 'adm.stock_alerts': 'Stock Alerts',
    'adm.all': 'All', 'adm.new': 'New', 'adm.progress': 'In Progress', 'adm.done': 'Completed',
    'adm.mark_paid': 'Mark paid', 'adm.start_prep': 'Start prep', 'adm.complete': 'Complete',
    'adm.paid_pill': 'PAID', 'adm.unpaid_pill': 'UNPAID',
    'adm.status.new': 'New', 'adm.status.progress': 'In Progress',
    'adm.status.done': 'Completed', 'adm.status.cancelled': 'Cancelled',
    'adm.ingredients': 'All Ingredients', 'adm.ingredients_sub': 'Color coding: Green OK · Amber Warning · Red Critical',
    'adm.avail_sub': 'Toggle availability — changes reflect instantly on customer site',
    'adm.allrev': 'All Reviews', 'adm.verifiedchron': 'Verified · ordered chronologically',
    'adm.ratingdist': 'Rating Distribution', 'adm.custseg': 'Customer Segmentation',
    'adm.members_sub': 'Earn 1 point / Rp1.000 · 100 points = Rp1.000 · tiers auto-assigned',
    'adm.allmbr': 'All Members', 'adm.mbr_sub': 'Sorted by current point balance · identity = WhatsApp number',
    'adm.analytics_sub': 'Live business intelligence — computed from real orders',
    'adm.rev7d': 'Revenue — Last 7 Days', 'adm.rev7d_sub': 'Paid orders only',
    'adm.topseller': 'Top Sellers', 'adm.topseller_sub': 'By cups sold',
    'adm.orderstatus': 'Order Status', 'adm.paymethod': 'Payment Methods',
    'adm.export_members': '⬇ Export Members CSV', 'adm.export_sales': '⬇ Sales Report',
    'adm.export_orders': '⬇ Orders CSV',
    ...
    'rev.eye': 'Customer Voices',
    'rev.h1': 'Honest <em>words,</em><br>from honest <em>tongues.</em>',
    'rev.desc': "Every review is verified. We don't filter, we don't censor.",
    'rev.stat.rating': 'Average Rating', 'rev.stat.total': 'Total Reviews',
    'rev.stat.five': '5-Star Reviews', 'rev.stat.reorder': 'Would Reorder',
    // Admin
    'adm.dashboard': 'Dashboard', 'adm.orders': 'Orders', 'adm.inventory': 'Inventory & Alerts',
    ...
    'adm.status.new': 'New', 'adm.status.progress': 'In Progress',
    'adm.status.done': 'Completed', 'adm.status.cancelled': 'Cancelled',
    'adm.ingredients': 'All Ingredients', 'adm.allrev': 'All Reviews',
    'adm.ratingdist': 'Rating Distribution', 'adm.custseg': 'Customer Segmentation',
    'adm.allmbr': 'All Members', 'adm.rev7d': 'Revenue Last 7 Days',
    'adm.topseller': 'Top Sellers', 'adm.orderstatus': 'Order Status',
    'adm.paymethod': 'Payment Methods',
